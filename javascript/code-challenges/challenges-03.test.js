...
const typeNum = (arr) => {
  // Solution code here...
  let filterarr = arr.filter(num => typeof(num) === 'number');
  return filterarr;
};
...
const containsAnd = (arr) => {
  // Solution code here...
  let filterstrarr = arr.filter((str) => str.includes('and'));
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let realArr = arr.filter(num => forbiddenValues.indexOf(num)=== -1);
  return realArr;
};
